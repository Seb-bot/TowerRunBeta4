...
backGroundImage2 = loadImage("DungeonBackground2.jpg")
...
setBorder = createSprite(850,260,150,10);
setBorder2 = createSprite(850,80,150,10);
...
setBorder3 = createSprite(150,260,150,10);
setBorder4 = createSprite(150,80,150,10);
setBorder3.visible = false;
setBorder4.visible = false;

Platform27 = createSprite(500,120,150,10);
...
ladder = createSprite(500,5,10,10)
ladder.scale = 0.3
...
case 1:
    zombie3 = new Zombie(Platform22.body.position.x,Platform22.body.position.y,50,50)
break

case 2:
    zombie3 = new Zombie(Platform23.body.position.x,Platform23.body.position.y,50,50)
break

case 3:
    zombie3 = new Zombie(Platform24.body.position.x - 10,Platform24.body.position.y - 10,50,50)
break
}
}
//level 2 
else if(gameState === 2){
Platform28 = createSprite(500,950,150,10);
Platform28.shapeColor = color("#552A0C");
Platform28.velocityX = -3;
setBorder5 = createSprite(900,950,10,100);
setBorder6 = createSprite(10,950,10,100);
setBorder5.visible = false;
setBorder6.visible = false;

Platform29 = new Platform(random(250,500),880,150,10);

//enemies level 2
zombie4 = new Zombie(500,950,25)
}
}
...
//level 1
if(gameState === 1){
if(player.body.position.x === 500 && player.body.position.y === 50){
    gameState = 2
    Platform25.destroy()
    Platform26.destroy()
    Platform27.destroy()
...
if(Platform28.isTouching(setBorder5)||Platform28.isTouching(setBorder6)){
Platform28.velocityX =  Platform28.velocityX*(-1)
}
Platform29.display()
zombie4.display()
}
